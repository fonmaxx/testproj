...
class sfSessionStorage extends sfStorage {
	static protected $sessionIdRegenerated = false, $sessionStarted = false;
	...
	public function initialize($options = null) {
		...
		$options = array_merge(
				array('session_name' => 'symfony',
						...
						'session_cookie_httponly' => isset(
								$cookieDefaults['httponly']) ? $cookieDefaults['httponly']
								: false, 'session_cache_limiter' => null,),
				$options);
