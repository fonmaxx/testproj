...
class sfCommandOption {
	...
	protected $name = null, $shortcut = null, $mode = null, $default = null, $help = '';
	...
	public function isParameterRequired() {
		return self::PARAMETER_REQUIRED
				=== (self::PARAMETER_REQUIRED & $this->mode);
	}
	...
	public function isParameterOptional() {
		return self::PARAMETER_OPTIONAL
				=== (self::PARAMETER_OPTIONAL & $this->mode);
	}
	...
	public function setDefault($default = null) {
		if (self::PARAMETER_NONE === (self::PARAMETER_NONE & $this->mode)
				&& null !== $default) {
			throw new sfCommandException(
					'Cannot set a default value when using sfCommandOption::PARAMETER_NONE mode.');
		}
