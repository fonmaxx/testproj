...
abstract class sfFormObject extends BaseForm {
	protected $isNew = true, $object = null;
	 ...
	 */
	public function bindAndSave($taintedValues, $taintedFiles = null,
			$con = null) {
	...
	public function updateObjectEmbeddedForms($values, $forms = null) {
		...
		foreach ($forms as $name => $form) {
			...
			if ($form instanceof sfFormObject) {
				...
				$this
						->updateObjectEmbeddedForms($values[$name],
	...
	protected function camelize($text) {
		return preg_replace(array('#/(.?)#e', '/(^|_|-)+(.)/e'),
