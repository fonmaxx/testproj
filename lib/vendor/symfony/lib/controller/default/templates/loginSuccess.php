...
<div class="sfTMessageContainer sfTLock"> 
  <?php echo image_tag('/sf/sf_default/images/icons/lock48.png',
		array('alt' => 'login required', 'class' => 'sfTMessageIcon',
				'size' => '48x48')) ?>
...
<dl class="sfTMessageInfo">
  ...
  <dd>
    <ul class="sfTIconList">
      <li class="sfTLinkMessage"><?php echo link_to('Proceed to login',
		sfConfig::get('sf_login_module') . '/'
				. sfConfig::get('sf_login_action')) ?></li>
