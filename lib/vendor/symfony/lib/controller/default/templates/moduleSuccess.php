...
<div class="sfTMessageContainer sfTMessage"> 
  <?php echo image_tag('/sf/sf_default/images/icons/ok48.png',
		array('alt' => 'module created', 'class' => 'sfTMessageIcon',
				'size' => '48x48')) ?>
...
<dl class="sfTMessageInfo">
  ...
  <dd>
    <ul class="sfTIconList">
      <li class="sfTDirectoryMessage">Browse to the <code>apps/<?php echo sfContext::getInstance()
		->getConfiguration()->getApplication() ?>/modules/<?php echo $sf_params
		->get('module') ?>/</code> directory</li>
      ...
      <li class="sfTLinkMessage"><?php echo link_to(
		'Learn more from the online documentation',
		'http://www.symfony-project.org/doc') ?></li>
    </ul>
  </dd>
</dl>
