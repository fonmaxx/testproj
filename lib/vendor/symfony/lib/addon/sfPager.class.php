...
abstract class sfPager implements Iterator, Countable {
	protected $page = 1, $maxPerPage = 0, $lastPage = 1, $nbResults = 0, $class = '', $tableName = '', $objects = null, $cursor = 1, $parameters = array(), $currentMaxLink = 1, $parameterHolder = null, $maxRecordLimit = false, 
	// used by iterator interface
	$results = null, $resultsCounter = 0;
