...
class sfModelGeneratorConfigurationField {
	protected $name = null, $config = null;
	...
	public function getConfig($key = null, $default = null, $escaped = false) {
		...
		$value = sfModelGeneratorConfiguration::getFieldConfigValue(
	...
	public function isReal() {
		return isset($this->config['is_real']) ? $this->config['is_real']
				: false;
	}
	...
	public function isPartial() {
		return isset($this->config['is_partial']) ? $this->config['is_partial']
				: false;
	}
	...
	public function isComponent() {
		return isset($this->config['is_component']) ? $this
						->config['is_component'] : false;
	}
	...
	public function isLink() {
		return isset($this->config['is_link']) ? $this->config['is_link']
				: false;
	}
	...
	public function getRenderer() {
		return isset($this->config['renderer']) ? $this->config['renderer']
				: null;
	}
	...
	public function getRendererArguments() {
		return isset($this->config['renderer_arguments']) ? $this
						->config['renderer_arguments'] : array();
	}
