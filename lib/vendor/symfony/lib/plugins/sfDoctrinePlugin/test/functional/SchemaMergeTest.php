...
$t
		->is_deeply($table->getColumnDefinition('name'),
				array('type' => 'string', 'length' => 255, 'notnull' => true,),
				'the short "type" syntax is expanded');

$t
		->is_deeply($table->getColumnDefinition('weight'),
				array('type' => 'float', 'length' => 4, 'scale' => 4,),
...
$t
		->is($options['updated']['disabled'], true,
				'the short "actAs" syntax is expanded');
