			...
			->is(
					file_exists(
							sfConfig::get('sf_lib_dir') . '/form/doctrine/'
									. $model . 'Form.class.php'), false);
	$t
			->is(
					file_exists(
							sfConfig::get('sf_lib_dir')
									. '/form/doctrine/base/Base' . $model
									. 'Form.class.php'), false);
	$t
			->is(
					file_exists(
							sfConfig::get('sf_lib_dir') . '/filter/doctrine/'
									. $model . 'FormFilter.class.php'), false);
	$t
			->is(
					file_exists(
							sfConfig::get('sf_lib_dir')
									. '/filter/doctrine/base/Base' . $model
									. 'FormFilter.class.php'), false);
}
...
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/form/doctrine/FormGeneratorTestForm.class.php'),
				true);
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/form/doctrine/base/BaseFormGeneratorTestForm.class.php'),
				true);
...
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/filter/doctrine/FormGeneratorTestFormFilter.class.php'),
				false);
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/filter/doctrine/base/BaseFormGeneratorTestFormFilter.class.php'),
				false);
...
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/form/doctrine/FormGeneratorTest2Form.class.php'),
				false);
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/form/doctrine/base/BaseFormGeneratorTest2Form.class.php'),
				false);
...
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/filter/doctrine/FormGeneratorTest2FormFilter.class.php'),
				true);
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/filter/doctrine/base/BaseFormGeneratorTest2FormFilter.class.php'),
				true);
...
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/form/doctrine/FormGeneratorTest3Form.class.php'),
				false);
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/form/doctrine/base/BaseFormGeneratorTest3Form.class.php'),
				false);
...
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/filter/doctrine/FormGeneratorTest3FormFilter.class.php'),
				false);
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/filter/doctrine/base/BaseFormGeneratorTest3FormFilter.class.php'),
				false);
...
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/form/doctrine/FormGeneratorTest3TranslationForm.class.php'),
				false);
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/form/doctrine/base/BaseFormGeneratorTest3TranslationForm.class.php'),
				false);
...
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/filter/doctrine/FormGeneratorTest3TranslationFormFilter.class.php'),
				false);
$t
		->is(
				file_exists(
						sfConfig::get('sf_lib_dir')
								. '/filter/doctrine/base/BaseFormGeneratorTest3TranslationFormFilter.class.php'),
				false);
