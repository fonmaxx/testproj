...
$data = array('username' => 'jwage', 'password' => 'changeme',
		'Profile' => array('first_name' => 'Jonathan', 'last_name' => 'Wage'));
...
$widget = new sfWidgetFormDoctrineChoice(
		array('model' => 'User', 'key_method' => 'getUsername',
				'method' => 'getPassword'));
$t
		->is($widget->getChoices(),
				array('jwage' => '4cb9c8a8048fd02294477fcb1a41191a'));
...
$methods = array('widgetChoiceTableMethod1', 'widgetChoiceTableMethod2',
		'widgetChoiceTableMethod3');

foreach ($methods as $method) {
	$widget = new sfWidgetFormDoctrineChoice(
			array('model' => 'User', 'table_method' => $method));
	$t->is($widget->getChoices(), array(1 => 1));
}

$widget = new sfWidgetFormDoctrineChoice(
		array('model' => 'User', 'table_method' => 'widgetChoiceTableMethod4'));
...
$data = array('username' => 'jonwage', 'password' => 'changeme',
		'Groups' => array(
				0 => array('name' => 'New User Group 1 Name'),
				1 => array('name' => 'New User Group 2 Name')));
