...
$q = Doctrine_Query::create()->from('Author a');
...
$q = Doctrine_Query::create()->from('Article a')->leftJoin('a.Translation t');
...
$t
		->is($conn1->getOption('dsn'),
				'sqlite:'
						. str_replace(DIRECTORY_SEPARATOR, '/',
								sfConfig::get('sf_data_dir'))
						. '/database1.sqlite');
$t
		->is($conn2->getOption('dsn'),
				'sqlite:'
						. str_replace(DIRECTORY_SEPARATOR, '/',
								sfConfig::get('sf_data_dir'))
						. '/database2.sqlite');
$t
		->is($conn3->getOption('dsn'),
				'sqlite:'
						. str_replace(DIRECTORY_SEPARATOR, '/',
								sfConfig::get('sf_data_dir'))
						. '/database3.sqlite');
...
$t
		->is($conn3->getAttribute(Doctrine_Core::ATTR_EXPORT),
