...
class sfDoctrinePager extends sfPager implements Serializable {
	protected $query = null, $tableMethodName = null, $tableMethodCalled = false;
	...
	public function getQuery() {
		if (!$this->tableMethodCalled && $this->tableMethodName) {
			...
			$this->query = Doctrine_Core::getTable($this->getClass())
					->$method($this->query);
	...
	protected function retrieveObject($offset) {
		...
		$queryForRetrieve->offset($offset - 1)->limit(1);
