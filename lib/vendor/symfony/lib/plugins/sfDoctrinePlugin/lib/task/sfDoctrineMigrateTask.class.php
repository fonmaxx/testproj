				...
				->addOptions(
						array(
								...
								new sfCommandOption('env', null,
										...
										'The environment', 'dev'),
								new sfCommandOption('up', null,
										sfCommandOption::PARAMETER_NONE,
										'Migrate up one version'),
								new sfCommandOption('down', null,
										sfCommandOption::PARAMETER_NONE,
...
EOF;
	...
	protected function execute($arguments = array(), $options = array()) {
		...
		if ($from == $version) {
			$this
					->logSection('doctrine',
							sprintf('Already at migration version %s', $version));
			return;
		}

		$this
				->logSection('doctrine',
						sprintf('Migrating from version %s to %s%s', $from,
								$version,
